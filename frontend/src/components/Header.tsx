...
export default function Header({
  ...
  return (
    <header
      className={`bg-surface-container-lowest flex justify-between items-center w-full px-margin sticky top-0 z-50 transition-all duration-300 ${isScrolled ? "shadow-md h-[72px]" : "shadow-sm h-20"}`}
    >
      <div
