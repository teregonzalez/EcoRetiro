...
export default function LandingPage({
  ...
  onLoginSuccess: (id: number, user: string, role: UserRole) => void;
}) {
  return (
    <>
        ...
        <div className="lg:col-span-8 relative overflow-hidden flex flex-col justify-center p-xl lg:p-[100px]">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <h1 className="font-display-lg text-display-lg text-white mb-md leading-tight">
              ...
              <span className="text-primary-fixed-dim">recurso del mañana</span>
              .
            </h1>
              ...
              <ul className="space-y-base">
                <li className="flex items-start gap-md">
                  ...
                  <div>
                    ...
                    <p className="text-[14px] text-on-surface-variant">
                      Trazabilidad completa de residuos bajo estándares
                      internacionales.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-md">
                  ...
                  <div>
                    ...
                    <p className="text-[14px] text-on-surface-variant">
                      Rutas optimizadas para recolección y entrega de
                      materiales.
                    </p>
                  </div>
                </li>
