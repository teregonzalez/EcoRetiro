        ...
        : activeTab === "Rutas"
          ...
          : activeTab === "Reportes"
            ? _jsx(ReportsView, {
                ...
                subtitle:
                  "Consulta indicadores de impacto, solicitudes y desempe\u00F1o ambiental de tu empresa.",
                roleLabel: "Generador PYME",
              })
            : _jsxs(_Fragment, {
                children: [
                  ...
                  _jsxs("section", {
                    className:
                      "mb-lg grid grid-cols-1 gap-gutter lg:grid-cols-3",
                    children: [
                      _jsxs("article", {
                        className:
                          "relative overflow-hidden rounded-xl bg-primary-container p-xl shadow-md lg:col-span-2",
                        children: [
                          _jsxs("div", {
                            className: "relative z-10 max-w-xl",
                            children: [
                              _jsx("h3", {
                                className: "font-headline-lg-mobile text-white",
                                children: "Listo para una nueva entrega",
                              }),
                              _jsx("p", {
                                className: "mt-sm text-on-primary-container",
                                children:
                              ...
                              _jsxs("button", {
                                ...
                                className:
                                  "mt-md inline-flex items-center gap-2 rounded-full bg-secondary-container px-md py-sm font-bold text-on-secondary-container transition-all hover:bg-secondary hover:text-on-secondary",
                                children: [
                                  _jsx("span", {
                          ...
                          _jsx("span", {
                            className:
                              "material-symbols-outlined pointer-events-none absolute -right-6 top-1/2 -translate-y-1/2 text-[220px] text-primary-fixed/20",
                      ...
                      _jsxs("article", {
                        ...
                        children: [
                          _jsx("p", {
                            className:
                              "font-label-sm uppercase tracking-wider text-on-surface-variant",
                            children: "Impacto Ambiental",
                          }),
                          _jsxs("p", {
                            className: "mt-md text-display-lg text-primary",
                            children: [
                              (data?.metrics.co2Saved ?? 0).toFixed(1),
                              " kg",
                            ],
                          }),
                          _jsx("p", {
                            className: "text-on-surface-variant",
                            children: "CO2 evitado estimado",
                          }),
                          _jsxs("div", {
                            ...
                            children: [
                              _jsx("div", {
                                className:
                                  "h-2 flex-1 overflow-hidden rounded-full bg-surface-container-high",
                                children: _jsx("div", {
                  ...
                  _jsxs("section", {
                    className: "grid grid-cols-1 gap-gutter xl:grid-cols-4",
                    children: [
                      _jsxs("article", {
                        className:
                          "overflow-hidden rounded-xl border border-outline-variant bg-surface-container-lowest shadow-sm xl:col-span-3",
                        children: [
                          _jsxs("div", {
                            className:
                            ...
                            children: [
                              _jsx("h3", {
                                ...
                                children: "Historial de Residuos",
                              }),
                              _jsx("button", {
                                type: "button",
                                          ...
                                          children: [
                                            ...
                                            _jsx("td", {
                                              ...
                                              children: _jsx("button", {
                                                ...
                                                className:
                                                  "font-label-sm text-secondary hover:underline",
                        ...
                        children: [
                          ...
                          _jsxs("div", {
                            ...
                            children: [
                              _jsxs("div", {
                                className:
                                  "rounded-lg bg-surface-container-low p-sm",
                                children: [
                                  _jsx("p", {
                                    className:
                                  ...
                                  _jsx("p", {
                                    ...
                                    children: data?.profile?.ubicacion ?? "-",
                                  }),
                                ],
                              }),
                              _jsxs("div", {
                                ...
                                children: [
                                  ...
                                  _jsx("p", {
                                    className: "text-body-md",
                                    children: data?.profile?.contacto ?? "-",
                                  }),
                                ],
                              }),
                              _jsxs("div", {
                                ...
                                children: [
                                  ...
                                  _jsx("p", {
                                    className: "text-body-md",
                                    children: data?.profile?.telefono ?? "-",
                                  }),
                                ],
                              }),
                            ],
                          ...
                          _jsxs("button", {
                            type: "button",
                            className:
                              "mt-md flex w-full items-center justify-center gap-2 rounded-lg border-2 border-primary py-sm font-bold text-primary transition-all hover:bg-primary hover:text-white",
                            children: [
                              _jsx("span", {
                                className: "material-symbols-outlined",
                                children: "edit",
