...
export default function PymeDashboard({ userId, username, onLogout, onCreateWaste }) {
    ...
    const navItems = [
        ...
        { label: "Reportes", icon: "analytics", active: activeTab === "Reportes", onClick: () => setActiveTab("Reportes") },
