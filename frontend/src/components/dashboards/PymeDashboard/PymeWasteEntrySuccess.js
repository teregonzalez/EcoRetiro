...
export default function PymeWasteEntrySuccess({ username, onLogout }) {
  ...
  return (
    <DashboardShell
      ...
      subtitle="Confirmación de ingreso y trazabilidad"
      username={username}
        ...
        <div className="relative mx-auto flex max-w-3xl flex-col items-center rounded-[2rem] bg-surface-container-lowest p-md text-center shadow-xl md:p-xl">
          ...
          <div className="mb-lg space-y-sm">
            ...
            <h1 className="font-display-lg leading-tight text-on-surface">
              Residuos registrados<br />
              <span className="text-primary">con éxito</span>
            </h1>
            
            <p className="mx-auto max-w-md text-on-surface-variant">
              La solicitud fue procesada correctamente y el equipo logístico ya fue notificado.
            </p>
          </div>

          {/* Tarjeta de Código de Seguimiento y Fecha */}
