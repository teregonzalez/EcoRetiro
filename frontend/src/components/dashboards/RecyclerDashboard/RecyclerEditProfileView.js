...
export default function RecyclerEditProfileView({ username, onLogout }) {
  ...
  return (
    <DashboardShell
      ...
      subtitle="Configuración del perfil de empresa receptora"
      username={username}
        ...
        <div className="grid grid-cols-12 gap-gutter">
          ...
          <aside className="col-span-12 space-y-xs lg:col-span-3">
            ...
            >
              ...
              <span className="font-label-sm">Información General</span>
            </a>
          ...
          <div className="col-span-12 space-y-gutter lg:col-span-9">
              ...
              <div className="flex flex-col items-start gap-xl md:flex-row">
                ...
                <div className="group flex flex-col items-center gap-md">
                  ...
                  <div className="flex flex-col items-center gap-xs">
                    <button type="button" className="font-label-sm text-primary hover:underline">
                      Cambiar Imagen
                    </button>
                    <button type="button" className="font-label-sm text-on-surface-variant/70 hover:text-error">
                      Eliminar
                    </button>
                  </div>
                </div>
            ...
            {/* Sección Preferencias de Economía Circular */}
            <section id="preferences" className="rounded-xl border-l-4 border-primary bg-surface-container-low p-lg shadow-sm">
              <div className="mb-lg flex items-center gap-sm">
                ...
                <h2 className="font-headline-lg-mobile text-on-surface">
                  Preferencias de Economía Circular
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 gap-xl md:grid-cols-2">
                ...
                <div className="space-y-md">
                  <label className="block font-label-sm text-on-surface-variant">
                    Capacidad de Recepción Semanal
                  </label>
                  <div className="pt-xs">
                    <input
                      type="range"
                  ...
                  <p className="text-[12px] italic text-on-surface-variant">
                    Este dato ayuda a optimizar la asignación de retiros en tu zona.
                  </p>
                </div>
              </div>
            </section>
              ...
              <div className="flex items-start gap-md">
                ...
                <div>
                  ...
                  <p className="mb-md max-w-xl text-on-surface-variant">
                    Al eliminar la cuenta se perderá el historial de trazabilidad y reportes de forma permanente.
                  </p>
                  <button
                    type="button"
