...
export default function RecyclerNearbyWasteView({ username, onLogout }) {
  ...
  const handleSubmit = (event) => {
    ...
    setTimeout(() => {
      setSubmitting(false);
      setSuccessMessage("Solicitud de retiro enviada al generador y al módulo logístico.");
    }, 1200);
  };
  ...
  return (
    <DashboardShell
      ...
      subtitle="Gestión de retiro para residuos cercanos"
      username={username}
                ...
                <form className="space-y-md" onSubmit={handleSubmit}>
                  ...
                  <div className="space-y-sm">
                    ...
                    <textarea
                      ...
                      placeholder="Indica acceso de camiones, ventanas de retiro o condición de embalaje..."
                    />
                  </div>
