...
const formatDetailDate = (rawDate) => {
...
const getStatusLabel = (historyEntry) => {
    ...
    return (
      <div className="rounded-xl border border-outline-variant bg-surface-container-lowest p-xl text-center shadow-sm">
        ...
        <p className="mt-sm text-on-surface-variant">
          Cuando existan materiales cercanos para retiro, aquí verás su detalle.
        </p>
      </div>
    );
  }
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col gap-lg">
        ...
        <div className="flex flex-col justify-between gap-md md:flex-row md:items-center">
          <div className="flex items-center gap-sm text-on-surface-variant">
            <span className="font-label-sm hover:text-secondary cursor-pointer">
              Red de retiro
            </span>
            <span className="material-symbols-outlined text-[16px]">chevron_right</span>
            <span className="font-label-sm text-on-surface">Material: {waste.material}</span>
          </div>
        ...
        <div className="grid grid-cols-1 gap-gutter lg:grid-cols-12">
          ...
          <div className="flex flex-col gap-gutter lg:col-span-8">
            ...
            <section className="group relative overflow-hidden rounded-xl bg-surface-container-lowest p-lg shadow-md transition-shadow duration-300 hover:shadow-lg">
              ...
              <div className="relative z-10 flex flex-col justify-between gap-lg md:flex-row md:items-start">
                <div>
                  <div className="mb-md flex flex-wrap items-center gap-sm">
                    ...
                    <div className={`rounded-full px-sm py-xs font-label-sm uppercase ${statusClasses}`}>
                      {status}
                    </div>
                  </div>
                ...
                <div className="flex min-w-[140px] flex-col items-center justify-center rounded-xl bg-surface-container-low p-md shadow-sm transition-transform group-hover:scale-105">
                  ...
                  <span className="font-headline-lg text-secondary">{amount.value}</span>
                  <span className="font-label-sm text-on-surface-variant">{amount.unit}</span>
                </div>
              </div>
              ...
              <div className="relative mt-lg grid grid-cols-2 gap-md pt-lg md:grid-cols-4">
                ...
                <div className="flex flex-col gap-xs">
                  <span className="font-label-sm uppercase text-on-surface-variant">Prioridad</span>
                  <div className="flex items-center gap-xs font-headline-lg-mobile text-on-surface">
                    ...
                    <span className="text-sm font-normal text-on-surface-variant">Volumen operativo</span>
                  </div>
                </div>

                <div className="flex flex-col gap-xs">
                  <span className="font-label-sm uppercase text-on-surface-variant">Disponibilidad</span>
                  <div className="flex items-center gap-xs font-headline-lg-mobile text-on-surface">
                    <span className="h-2 w-2 rounded-full bg-inverse-primary" />
                    <span className="text-sm font-normal">Lista para coordinación</span>
                  </div>
                </div>

                <div className="flex flex-col gap-xs">
                  <span className="font-label-sm uppercase text-on-surface-variant">Unidad</span>
                  <div className="flex items-center gap-xs font-headline-lg-mobile text-on-surface">
                ...
                <div className="flex flex-col gap-xs">
                  <span className="font-label-sm uppercase text-on-surface-variant">Seguimiento</span>
                  <div className="flex items-center gap-xs font-headline-lg-mobile text-on-surface">
            ...
            <section className="grid grid-cols-1 gap-gutter md:grid-cols-2">
              ...
              <article className="flex h-full flex-col rounded-xl bg-surface-container-lowest p-md shadow-sm transition-shadow hover:shadow-md">
                <h3 className="mb-md font-headline-lg-mobile text-on-surface">Resumen de carga</h3>
                <div className="flex flex-1 flex-col justify-center">
                  <div className="relative mx-auto mb-md aspect-square w-full max-w-[200px]">
                    <svg className="h-full w-full -rotate-90 transform" viewBox="0 0 100 100">
                      <circle className="text-surface-container" cx="50" cy="50" r="40" fill="transparent" stroke="currentColor" strokeWidth="12" />
                      <circle className="text-secondary drop-shadow-sm" cx="50" cy="50" r="40" fill="transparent" stroke="currentColor" strokeDasharray="188 251.2" strokeWidth="12" />
                      <circle className="text-secondary-fixed-dim" cx="50" cy="50" r="40" fill="transparent" stroke="currentColor" strokeDasharray="38 251.2" strokeDashoffset="-188" strokeWidth="12" />
                      <circle className="text-outline-variant" cx="50" cy="50" r="40" fill="transparent" stroke="currentColor" strokeDasharray="25.2 251.2" strokeDashoffset="-226" strokeWidth="12" />
                    </svg>
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      <span className="font-headline-lg text-on-surface">{waste.total.toFixed(0)}</span>
                      <span className="font-label-sm text-on-surface-variant">{waste.unit}</span>
                    </div>
                  </div>
                  ...
                  <div className="mt-auto flex flex-col gap-xs">
                    <div className="flex items-center justify-between text-sm">
                      <span className="flex items-center gap-xs">
                        <span className="h-3 w-3 rounded-sm bg-secondary" /> Material
                      </span>
                      <span className="font-bold">{waste.material}</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="flex items-center gap-xs">
                        <span className="h-3 w-3 rounded-sm bg-secondary-fixed-dim" /> Estado
                      </span>
                      <span className="font-bold">{status}</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="flex items-center gap-xs">
                        <span className="h-3 w-3 rounded-sm bg-outline-variant" /> Origen
                      </span>
                      <span className="font-bold">{historyEntry?.origen || "Red local"}</span>
                    </div>
                  </div>
                </div>
              </article>
              ...
              <article className="group relative overflow-hidden rounded-xl bg-surface-container-lowest p-md shadow-sm">
                ...
                <p className="mt-sm font-body-md text-on-surface-variant">
                  Estimación operativa para priorizar este retiro.
                </p>
                <div className="relative z-10 mt-md flex flex-col gap-sm">
                  <div className="flex items-center justify-between rounded-lg border border-transparent bg-surface p-sm shadow-[inset_0_1px_3px_rgba(0,0,0,0.02)] transition-colors hover:border-outline-variant/30">
                    <div className="flex items-center gap-sm">
                      ...
                      <div>
                        <span className="font-label-sm text-on-surface-variant">CO2 recuperable</span>
                        <p className="font-bold text-on-surface">{(waste.total * 0.18).toFixed(2)} kg</p>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center justify-between rounded-lg border border-transparent bg-surface p-sm shadow-[inset_0_1px_3px_rgba(0,0,0,0.02)] transition-colors hover:border-outline-variant/30">
                    <div className="flex items-center gap-sm">
                      ...
                      <div>
                        <span className="font-label-sm text-on-surface-variant">Agua equivalente</span>
                        <p className="font-bold text-on-surface">{(waste.total * 12).toFixed(0)} L</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="flex flex-col gap-md rounded-xl bg-surface-container-lowest p-md shadow-sm">
              <div className="flex items-center justify-between gap-sm">
                <h3 className="font-headline-lg-mobile text-on-surface">Ubicación y acceso</h3>
              ...
              <div className="relative h-64 overflow-hidden rounded-lg bg-[radial-gradient(circle_at_top,#d9e2ff_0%,#c8d3eb_22%,#adc1de_40%,#91a8c4_60%,#7c8fa7_100%)] shadow-inner">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative">
                    <span className="material-symbols-outlined text-[52px] text-error" style={{ fontVariationSettings: "'FILL' 1" }}>
                      location_on
                    </span>
              ...
              <div className="mt-xs flex items-start gap-sm">
                <span className="material-symbols-outlined mt-1 text-outline">info</span>
                <p className="font-label-sm leading-relaxed text-on-surface-variant">
                  {historyEntry?.origen
                    ...
                    : "Material disponible en la red local. Coordina el retiro desde el módulo logístico para continuar."}
                </p>
              </div>
            </section>
          </div>
          ...
          <div className="flex flex-col gap-gutter lg:col-span-4">
            ...
            <section className="overflow-hidden rounded-xl bg-surface-container-lowest p-md shadow-md">
              <h3 className="mb-md font-headline-lg-mobile text-on-surface">Logistics</h3>
              <div className="relative space-y-md before:absolute before:inset-y-0 before:left-[11px] before:w-px before:bg-outline-variant/40">
                ...
                <div className="relative z-10 flex gap-sm">
                  ...
                  <div className="flex flex-col">
                    <span className="font-label-sm uppercase text-secondary">Programación</span>
                    <span className="font-body-md font-medium text-on-surface">{schedule}</span>
                    <span className="mt-xs text-sm text-on-surface-variant">Disponible para coordinación de retiro.</span>
                  </div>
                </div>
                ...
                <div className="relative z-10 flex gap-sm">
                  ...
                  <div className="flex flex-col">
                    <span className="font-label-sm uppercase text-on-surface-variant">Origen</span>
                    <span className="font-body-md font-medium text-on-surface">{origin}</span>
                    <span className="mt-xs text-sm text-on-surface-variant">Seguimiento centralizado por material.</span>
                  </div>
                </div>
                ...
                <div className="relative z-10 flex gap-sm">
                  <div className="mt-0.5 h-6 w-6 shrink-0 rounded-full border-2 border-outline-variant bg-surface-container-lowest" />
                  <div className="flex flex-col">
                    <span className="font-label-sm uppercase text-on-surface-variant">Estado</span>
                    <span className="font-body-md font-medium text-on-surface">{status}</span>
                    <span className="mt-xs text-sm text-on-surface-variant">Volumen: {waste.total.toFixed(2)} {waste.unit}</span>
                  </div>
                </div>
            ...
            {/* Reclamar Ruta / Claim Collection */}
            <section className="rounded-xl bg-secondary p-md text-on-secondary shadow-lg transition-transform duration-300 hover:-translate-y-1">
              ...
              <p className="mt-sm text-sm text-secondary-fixed opacity-90">
                Asigna este material a tu flujo logístico y continúa con la solicitud de retiro.
              </p>
            ...
            <section className="flex items-center gap-md rounded-xl bg-surface-container-lowest p-md shadow-sm transition-shadow hover:shadow-md">
              ...
              <div className="flex flex-col">
                <span className="font-label-sm uppercase text-on-surface-variant">Material activo</span>
                <span className="font-body-md font-bold text-on-surface">{waste.material}</span>
                <div className="mt-xs flex items-center gap-xs text-sm">
                  ...
                  <span className="font-bold text-on-surface">
                    {status === "Gestionado" ? "4.8" : status === "En camino" ? "4.4" : "4.1"}
                  </span>
                  <span className="text-on-surface-variant">(prioridad operativa)</span>
                </div>
              </div>
            </section>
